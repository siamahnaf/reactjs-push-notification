...
const NotificationPrompt = (props) => {
    ...
    const [notificationPermission, setNotificationPermission] = (0, react_1.useState)("");
    (0, react_1.useEffect)(() => {
    ...
    return (react_1.default.createElement("div", null,
        notificationPermission === 'denied' && (react_1.default.createElement("div", { className: deniedClassName }, deniedTitle)),
        notificationPermission === 'not-set' && (react_1.default.createElement("div", { className: notSetClassName, onClick: handlePermissionRequest }, notSetTitle)),
        notificationPermission === "failed" && (react_1.default.createElement("div", { className: failedClassName }, failedTitle))));
};
exports.default = NotificationPrompt;
